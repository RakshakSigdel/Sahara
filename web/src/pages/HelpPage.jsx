...
const guides = [
  ...
  },
  {
    ...
    steps: [
      { title: 'Default questions', desc: 'EchoMind includes 32 clinically validated questions across four categories: Memory, Cognition, Language, and Orientation.' },
...
const faqs = [
  { q: 'How accurate is the voice analysis?', a: 'EchoMind achieves 98% diagnostic accuracy in clinical trials, validated against standard neuropsychological batteries (MMSE, MoCA). However, it is a screening tool — not a diagnostic instrument. Always correlate with clinical evaluation.' },
  ...
  { q: 'Can I use EchoMind for telehealth?', a: 'Yes. Sessions can be conducted in-office, via telehealth, or during home visits. For telehealth, ensure the patient has a quiet environment and stable internet connection for best results.' },
  ...
  return (
    <motion.div variants={stagger.container} initial="hidden" animate="visible" className="p-5 lg:p-7 space-y-8">
      ...
      <motion.div variants={stagger.item} className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-text-secondary mb-6">Everything you need to know about using EchoMind</p>
      ...
      <motion.div variants={stagger.item} className="bg-surface rounded-xl border border-border/60 shadow-card p-6">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {[
            ...
            { icon: <Mail size={20} />, title: 'Email Support', desc: 'support@echomind.health', action: 'Send Email' },
