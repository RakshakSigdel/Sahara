      ...
      <motion.div variants={stagger.item} className="mb-8">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm border-collapse min-w-[600px]">
            ...
            <tbody>
              {[
                { method: 'Voice-Based (Bhul Rakshak)', accuracy: '94-98%', invasive: 'None', cost: 'Free', access: '★★★★★', highlight: true },
      ...
      <motion.div variants={stagger.item}>
        ...
        <div className="space-y-3">
          {[
            ...
            { n: 2, title: 'Take a Screening Test', desc: 'Use Bhul Rakshak for a quick, non-invasive voice-based screening' },
