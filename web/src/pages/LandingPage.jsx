  ...
  return (
    <div className="bg-background">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger.container} className="mx-auto max-w-[1200px] px-6 lg:px-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            {[
              ...
              { n: '500+', l: 'Doctors Trust Bhul Rakshak', d: 'Across 50+ hospitals' },
      ...
      <section className="py-16 md:py-24">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger.container} className="mx-auto max-w-[1200px] px-6 lg:px-10">
          <motion.div variants={stagger.item} className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-extrabold text-navy-dark">Why Healthcare Professionals Choose Bhul Rakshak</h2>
          </motion.div>
      ...
      <section className="py-16 md:py-24">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="mx-auto max-w-[900px] px-6 lg:px-10">
          <h2 className="text-3xl font-extrabold text-navy-dark text-center mb-10">Bhul Rakshak vs Traditional Assessments</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse min-w-[500px]">
              <thead>
                <tr className="border-b-2 border-border/60">
                  <th className="text-left py-3 px-3 text-xs font-bold text-text-muted uppercase">Criteria</th>
                  <th className="text-center py-3 px-3 text-xs font-bold text-deep-teal uppercase">Bhul Rakshak</th>
      ...
      <section className="py-16 md:py-24 bg-muted/20">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="mx-auto max-w-[720px] px-6 lg:px-10">
          ...
          <FAQ question="Is this a replacement for comprehensive neuropsychological testing?" answer="No. Bhul Rakshak is a screening tool designed for early detection and longitudinal monitoring. Abnormal results should be followed up with comprehensive neuropsychological evaluation." />
          ...
          <FAQ question="What training is required?" answer="Minimal. Doctors can start using Bhul Rakshak after a 15-minute onboarding walkthrough. No special equipment needed — just a computer with a microphone." />
          <FAQ question="Can I use this for telehealth visits?" answer="Yes. Bhul Rakshak works across telehealth platforms. Patients can record on their own device, and results sync to your dashboard." />
