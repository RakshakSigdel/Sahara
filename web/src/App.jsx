...
const ActiveSessionPage = lazy(
  () => import("./pages/session/ActiveSessionPage"),
);
const SessionReviewPage = lazy(
  () => import("./pages/session/SessionReviewPage"),
);
const SessionReportPage = lazy(
  () => import("./pages/session/SessionReportPage"),
);
const QuestionBankPage = lazy(
  () => import("./pages/questions/QuestionBankPage"),
);
...
function Placeholder({ title, desc }) {
  return (
    <div className="p-6 lg:p-8">
      <h1 className="text-2xl font-bold text-navy-dark mb-2">{title}</h1>
