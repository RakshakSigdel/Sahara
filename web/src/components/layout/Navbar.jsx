    ...
    >
      <nav className="mx-auto max-w-[1280px] flex items-center justify-between h-[72px] px-6 lg:px-10">
        ...
        <div className="hidden lg:flex items-center gap-2.5">
          ...
          <Button size="sm" className="shadow-sm hover:shadow-glow transition-shadow duration-300 px-5" onClick={() => navigate('/demo')}>
            Request Demo
          </Button>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="px-4 pb-6 space-y-2">
                <Button variant="outline" className="w-full" onClick={() => { setMobileOpen(false); navigate('/auth/login'); }}>
                  Doctor Login
                </Button>
                <Button className="w-full" onClick={() => { setMobileOpen(false); navigate('/demo'); }}>
                  Request Demo
                </Button>
              </div>
            </motion.div>
